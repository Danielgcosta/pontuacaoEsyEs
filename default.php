...
//Defini磯 da ordem das patrulhas
...
//Defini磯 das esferas das patrulhas
function defEsferas()
{
...
<HEAD>
<TITLE>Pontua磯 das Patrulhas</TITLE>
...
<table colspan="3"  width=600 height=600 border=0 background="img/bg.png" id="table">
	...
	<tr height=100%>
		<td></td>
		<td>
			<p><font size="6" color="green" font-family="Myriad Pro"><a><script type="text/javascript">document.write(ciclo);</script></a>� Ciclo de <a><script type="text/javascript">document.write(ano);</script></a> - Result. parcial<br>Pontua磯 das Patrulhas</font></p>
		</td>
		<td></td>
	</tr>
	<tr height="20"> 
			...
			<table border=0 align="center">
				...
				<tr height="40" margin=0> <!--3 row-->
					<td rowspan="3" align="center">
						<img src="img/castor.png" width="160" height="160" style="display: none;" id="castorSphere1">	<!--impress㯠da esfera do 1� lugar-->
				...
				<tr height="40"> <!--4 row-->
					<td rowspan="3" align="center">
						<img src="img/castor.png" width="160" height="160" style="display: none;" id="castorSphere2">	<!--impress㯠da esfera do 2� lugar-->
				...
				<tr height="60"> <!--5 row-->
					<td rowspan="3" align="center">
						<img src="img/castor.png" width="160" height="160" style="display: none;" id="castorSphere3">	<!--impress㯠da esfera do 3� lugar-->
...
<!--comentado at頡tualizar a listagem de pontua磯 
			<a href="http://www.pontuacao.esy.es/img/listaPontos.png" target="_blank"><font size="2" color="white">Veja aqui as regras de pontua磯</a></font>
-->	
